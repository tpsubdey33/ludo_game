...
export const handleForwardThunk=(playerNo,id,pos)=>async(dispatch,getState)=>{
    ...
    const piece=peicesAtPosition[peicesAtPosition.findIndex(item=>item.id[0]==alpha)];
    ...
    const upadtedPlottedPieces=selectCurrentPositions(updatedState);
    //check Colliding
    const finalPlot=upadtedPlottedPieces?.filter(
